...
mm = pd.read_parquet('/mnt/c/Users/araza/Documents/1/git repos/Data-Pipeline/files/ctbs_merged.parquet')
...
mm.to_parquet('/mnt/c/Users/araza/Documents/1/git repos/Data-Pipeline/files/Transaction Table.parquet')
...
view.to_excel('/mnt/c/Users/araza/Documents/1/git repos/Data-Pipeline/files/Weekly View.xlsx')
